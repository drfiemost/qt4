...
void QTabWidget::initStyleOption(QStyleOptionTabWidgetFrame *option) const
{
    ...
    if (QStyleOptionTabWidgetFrame *tabframe = qstyleoption_cast<QStyleOptionTabWidgetFrame*>(option)) {
...
QTabWidget::QTabWidget(QWidget *parent)
    : QWidget(*new QTabWidgetPrivate, parent, nullptr)
{
    Q_D(QTabWidget);
    d->init();
}
