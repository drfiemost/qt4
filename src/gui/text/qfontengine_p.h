...
public:
    ...
    qreal minLeftBearing() const override { return 0; }
    qreal minRightBearing() const override { return 0; }
...
public:
    ...
    Type type() const override { return TestFontEngine; }
};
