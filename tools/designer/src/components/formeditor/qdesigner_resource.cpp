    ...
    if (widgetInfoIndex != -1) {
        ...
        while (customInfo && customInfo->isCustom()) {
            ...
            if (extends == customInfo->name()) {
                ...
                customInfo = extendsIndex != -1 ?  wdb->item(extendsIndex) : static_cast<QDesignerWidgetDataBaseItemInterface *>(nullptr);
            }
        }
    }
    ...
    if (resources != nullptr) {
        ...
        foreach (DomResource *res, dom_include) {
            ...
            while (!QFile::exists(path)) {
                ...
                const QString promptTitle = QApplication::translate("qdesigner_internal::QDesignerResource", "Loading qrc file", nullptr, QApplication::UnicodeUTF8);
                const QString prompt = QApplication::translate("qdesigner_internal::QDesignerResource", "The specified qrc file <p><b>%1</b></p><p>could not be found. Do you want to update the file location?</p>", nullptr, QApplication::UnicodeUTF8).arg(path);
                ...
                if (answer == QMessageBox::Yes) {
                    ...
                    const QString fileDialogTitle = QApplication::translate("qdesigner_internal::QDesignerResource", "New location for %1", nullptr, QApplication::UnicodeUTF8).arg(fi.fileName());
                    const QString fileDialogPattern = QApplication::translate("qdesigner_internal::QDesignerResource", "Resource files (*.qrc)", nullptr, QApplication::UnicodeUTF8);
