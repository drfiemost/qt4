...
inline QMetaEnum metaEnum(const char *name, const QObjectType* = nullptr)
{
...
inline EnumType enumKeyOfObjectToValue(const char *enumName, const char *key, const QObjectType* = nullptr, const EnumType* = nullptr)
{
