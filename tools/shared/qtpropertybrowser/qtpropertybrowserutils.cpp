...
{
    return QApplication::translate("QtPropertyBrowserUtils", "[%1, %2, %3] (%4)", nullptr, QApplication::UnicodeUTF8)
...
{
    return QApplication::translate("QtPropertyBrowserUtils", "[%1, %2]", nullptr, QApplication::UnicodeUTF8)
                                  .arg(f.family())
                                  .arg(f.pointSize());
}
