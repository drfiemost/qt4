 ...
 */
class OrgQtprojectQtDBusPingerInterface: public QDBusAbstractInterface
{
    Q_OBJECT
public:
...
public:
    OrgQtprojectQtDBusPingerInterface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);

    ~OrgQtprojectQtDBusPingerInterface();
...
namespace org {
  namespace qtproject {
    namespace QtDBus {
      typedef ::OrgQtprojectQtDBusPingerInterface Pinger;
    }
  }
}
#endif
